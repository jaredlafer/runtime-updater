...
class LogSetup(object):
    ...
    def init_app(self, app):
        """
        Sets up the logging. There are three log types: stream, watched, and rotate, each of which
        have different handlers. There's a default handler as well as an access handler.
